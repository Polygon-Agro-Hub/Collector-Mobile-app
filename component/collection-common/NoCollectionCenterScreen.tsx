...
type NoCollectionCenterScreenNavigationProps = StackNavigationProp<
  RootStackParamList,
  "NoCollectionCenterScreen"
>;
...
const NoCollectionCenterScreen: React.FC<NoCollectionCenterScreenProps> = ({
  navigation,
}) => {
    ...
    <ScrollView className="flex-1 bg-white ">
      <View className="flex-1 bg-white justify-center items-center">
        ...
        <View className="items-center mb-[25%]">
          <Text className="text-lg font-semibold  text-black-300 mt-[20%]">
            {t("NoCollectionCenterScreen.ErrorFound")}
          </Text>
