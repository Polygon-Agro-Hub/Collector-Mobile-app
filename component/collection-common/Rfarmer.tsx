    ...
    <View className="flex-1 bg-white">
      ...
      <View className="ml-[10%] mr-[10%] flex-1">
        <ScrollView contentContainerStyle={{ paddingBottom: 20 }}>
          ...
          <Text className="text-base pb-[2%] font-medium">
            {t("Registeredfarmer.AccountName")}
          </Text>
          <View className="flex-row items-center border w-full h-[40px] mb-5 bg-white px-3">
            <TextInput
              className="flex-1 h-[40px] text-base pl-2"
          ...
          <TouchableOpacity
            ...
            onPress={() => navigation.navigate("Ufarmercropdetails")}
          >
            <Text className="text-center text-xl font-light text-white">
              {t("Registeredfarmer.Next")}
            </Text>
          </TouchableOpacity>
        </ScrollView>
