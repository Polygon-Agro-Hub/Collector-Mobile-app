...
type AddOfficerNavigationProp = StackNavigationProp<
  RootStackParamList,
  "AddOfficer"
>;
...
const AddOfficer: React.FC<AddOfficerProp> = ({ route, navigation }) => {
  ...
  // Step 2: Address/Bank Details states
  ...
  const resetForm = () => {
    setFormData({
      ...
      email: "",
      profileImage: "",
      jobRole: String(route.params?.jobRolle || "Collection Officer"),
      phoneCode1: "",
      phoneNumber1: "",
      phoneCode2: "",
      phoneNumber2: "",
    ...
    const init = async () => {
      try {
        ...
        if (storedData) {
          ...
          const role = String(route.params?.jobRolle || "Collection Officer");
          setJobRole(role);
    ...
    >
      ...
      {step === 1 ? (
        ...
        >
          ...
          <View className="">
            <View className="px-0 mt-6 items-center">
            ...
            <View className="px-0 mt-4 gap-4">
              <View>
                <TextInput
            ...
            {/* Buttons */}
            <View className="px-0 flex-col w-full gap-4 mt-6">
              <TouchableOpacity
        ...
        <View className="flex-1 bg-white w-full max-w-[500px] mx-auto px-6">
          <ScrollView
            ...
            contentContainerStyle={{ paddingBottom: 100 }}
          >
            {/* Step 2: Address/Bank Details View */}
            <View className="px-0 mt-4">
              {/* House Number */}
              <TextInput
